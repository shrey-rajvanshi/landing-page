    ...
    <section className="py-12 bg-gray-50 sm:py-16 lg:py-20">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="text-center lg:text-left lg:flex lg:items-center lg:justify-between">
          <h2 className="max-w-sm mx-auto text-3xl font-bold text-gray-900 lg:mx-0">
        ...
        <div className="grid grid-cols-1 mt-12 text-center sm:px-16 md:px-0 md:gap-x-8 gap-y-12 md:text-left md:grid-cols-3">
          <div>
            ...
            <div className="flex items-center  mt-7 justify-between">
              ...
              <button
                type="button"
                className="inline-flex items-center justify-center px-2 py-1.5 text-sm leading-4 rounded-md border border-transparent transition-all duration-200 text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600 bg-indigo-600 hover:bg-indigo-500 font-semibold"
              >
                ⚡0.5 latency
              </button>
            </div>
          ...
          <div>
            <img
              ...
              alt=""
            />
            <p className="text-lg font-bold text-gray-900 mt-7">
              Leslie Alexander
            </p>
            <p className="mt-3 text-sm font-medium text-gray-500">
